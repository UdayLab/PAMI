...
class relativePatterns(ABC):
    ...
    def __init__(self, iFile, minSup, minRsup, sep="\t"):
        ...
        :param minRsup: The user given minimum all confidence Ratio(should be in range of 0 to 1)
        :type minRsup :float
    ...
    @abstractmethod
    def minRsup(self):
        """Variable to store the user-specified minimum All confidence ratio value"""
