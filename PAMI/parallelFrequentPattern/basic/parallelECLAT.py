...
from PAMI.parallelFrequentPattern.basic import abstract as _ab
...
class parallelECLAT(_ab._frequentPatterns):
    """
        ...
        -------------------------------
            ...
            Examples:
            ---------
                python3 parallelECLAT.py sampleDB.txt patterns.txt 1000 10  (minSup will be considered in support count or frequency)
        """
    ...
    def __init__(self, iFile, minSup, numWorkers, sep='\t'):
        super().__init__(iFile, float(minSup), sep)
