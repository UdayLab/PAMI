...
class ThreePGrowth(partialPeriodicPatterns):
    ...
    """ 3pgrowth is fundamental approach to mine the partial periodic patterns in temporal database.
        ...
        Parameters
           ...
           self. oFile : file
            ...
            self.mapSupport : Dictionary
                To maintain the information of item and their frequency
            self.lno : int
                it represents the total no of transactions
            self.tree : class
                it represents the Tree class
            self.itemSetCount : int
        ...
        Format: python3 ThreePGrowth.py <inputFile> <outputFile> <minSup>
        Examples: python3 ThreePGrowth.py sampleDB.txt patterns.txt 10.0   (minSup will be considered in percentage of database transactions)
                  python3 ThreePGrowth.py sampleDB.txt patterns.txt 10     (minSup will be considered in support count or frequency)
    ...
    def creatingItemSets(self):
        ...
        try:
            with open(self.iFile, 'r', encoding='utf-8') as f:
                for line in f:
                    li1 = [i.strip() for i in line.split("\t")]
    ...
    def startMine(self):
        ...
        for i in patterns:
            ...
            self.finalPatterns[tuple(s)] = i[1]
