...
class FCFP(corelatedFuzzyFrequentPatterns):
    """
        FCFP is the algorithm to discover Correlated Fuzzy-frequent patterns in a transactional database.
    ...
    -------
            Format: 
                python3 FCFP.py <inputFile> <outputFile> <minSup> <minAllConf> <sep>
            Examples: 
                    python3 FCFP.py sampleTDB.txt output.txt 2 0.2 (minSup will be considered in support count or frequency)
    ...
    def startMine(self):
        ...
        print("Fuzzy Correlated Patterns Successfully generated using FCFP algorithms")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 5 or len(sys.argv) == 6:
        ...
        for i in minsup:
            ap = FCFP('/home/apiiit-rkv/Downloads/Reaserch/maximal/retail_utility_spmf.txt', i, 0.4, ' ')
            ap.startMine()
            print(ap.minSup)
