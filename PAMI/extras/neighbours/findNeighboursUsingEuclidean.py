#  findNeighboursUsingEuclidean is used to   create a neighbourhood file using euclid distance.
#
#
...
#
#
#     obj = db.findNeighboursUsingEuclidean(iFile, oFile,maxEuclideanDistance, "\t")
#
#     obj.save()
#
#
...
class createNeighborhoodFileUsingEuclideanDistance:
    ...
    **Importing this algorithm into a python program**
    ...
    def __init__(self,iFile: str,oFile: str,maxEuclideanDistance: int, seperator='\t'):
        self.iFile = iFile
        self.oFile = oFile
        self.maxEuclideanDistance = maxEuclideanDistance
        ...
        for i in range(len(coordinates)):
            for j in range(len(coordinates)):
                if i != j:
                    ...
                    norm = sqrt(dist)
                    if norm <= float(self.maxEuclideanDistance):
...
if __name__ == "__main__":
    ...
    obj = createNeighborhoodFileUsingEuclideanDistance(sys.argv[1], sys.argv[2], sys.argv[3])
