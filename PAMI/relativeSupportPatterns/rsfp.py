...
#      You should have received a copy of the GNU General Public License
#      along with this program.  If not, see <https://www.gnu.org/licenses/>.
from PAMI.relativeSupportPatterns.abstract import *
import sys
import math
...
class rsfp(frequentPatterns):
    """ 
        ...
        Examples:
        ---------
        python3 rsfp.py sampleDB.txt patterns.txt 0.23 0.2  (minSup will be considered in percentage of database transactions)

        python3 rsfp.py sampleDB.txt patterns.txt 3   0.2  (minSup will be considered in support count or frequency)
