# cuFFIMiner is a fundamental algorithm to discover fuzzy frequent patterns in a quantitative transactional database using CUDA. This program employs the downward closure property to reduce the search space effectively. This algorithm employs breadth-first search technique to find the complete set of fuzzy frequent patterns in a quantitative transactional database.
#
#
# **Importing this algorithm into a python program**
# ----------------------------------------------------
#
#             import PAMI.fuzzyFrequentPattern.cuda.cuFFIMiner as alg
#
#             obj = alg.cuFFIMiner(iFile, minSup)
#
#             obj.mine()
#
...
class cuFFIMiner(_ab._fuzzyFrequentPatterns):
    """
    :Description: cuFFIMiner is a fundamental algorithm to discover fuzzy frequent patterns using Cuda in a quantitative transactional database. This program employs the downward closure property to reduce the search space effectively. This algorithm employs breadth-first search technique to find the complete set of fuzzy frequent patterns in a quantitative transactional database.
    ...
    **Methods to execute code on terminal**
    ...
    .. code-block:: console
      ...
      (.venv) $ python3 cuFFIMiner.py <inputFile> <outputFile> <minSup>

      Example Usage:

      (.venv) $ python3 cuFFIMiner.py sampleDB.txt patterns.txt 10.0
    ...
    **Credits:**
    ...
    def mine(self):
        ...
        print("Fuzzy frequent patterns were generated successfully using cuFFIMiner algorithm ")
    ...
    def getPatternsAsDataFrame(self):
        """
        Storing final fuzzy frequent patterns in a dataframe
    ...
    def save(self, outFile):
        """
        Complete set of fuzzy frequent patterns will be loaded in to an output file
    ...
    def getPatterns(self):
        """
        Function to send the set of fuzzy frequent patterns after completion of the mining process
        :return: returning fuzzy frequent patterns
        :rtype: dict
        """
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 4 or len(_ab._sys.argv) == 5:
        if len(_ab._sys.argv) == 5:
            _ap = cuFFIMiner(_ab._sys.argv[1], _ab._sys.argv[3], _ab._sys.argv[4])
        if len(_ab._sys.argv) == 4:
            _ap = cuFFIMiner(_ab._sys.argv[1], _ab._sys.argv[3])
        _ap.mine()
