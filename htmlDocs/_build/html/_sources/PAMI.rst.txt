...
.. toctree::
   ...
   PAMI.coveragePatterns
   PAMI.extras
   PAMI.faultTolerantFrequentPattern
   PAMI.frequentPattern
   PAMI.frequentSpatialPattern
   PAMI.fuzzyCorrelatedPattern
   PAMI.fuzzyFrequentPatterns
   PAMI.fuzzyFrequentSpatialPattern
   PAMI.fuzzyPeriodicFrequentPattern
   PAMI.fuzzySpatialPeriodicFrequentPattern
   PAMI.geoReferencedFrequentPattern
   PAMI.geoReferencedPeriodicFrequentPattern
   PAMI.highUtilityFrequentPatterns
   PAMI.highUtilityFrequentSpatialPattern
   PAMI.highUtilityPatterns
   ...
   PAMI.partialPeriodicSpatialPattern
   PAMI.periodicCorrelatedPattern
   PAMI.periodicFrequentPattern
   PAMI.recurringPattern
   PAMI.relativeFrequentPatterns
   PAMI.relativeHighUtilityPatterns
