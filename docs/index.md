...
Chapter 3: Converting dataframes to databases
   ...
   1. [Format of dense dataframe](./manuals/DenseFormatDF2DB.html) 
   2. [Format of sparse dataframe](./manuals/sparseFormatDF2DB.html)
   3. [Approaches to convert a dataframe into various database formats](./manuals/DenseFormatDF2DB.html)
