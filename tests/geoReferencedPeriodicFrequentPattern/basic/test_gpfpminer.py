...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 7:
        ...
        maxPer = float(_ab._sys.argv[3])
        nFile=_ab._sys.argv[4]
        ...
        print("Maximum Periodicity:", maxPer)
        print("nFile:", nFile)
        print("Output File:", oFile)
        print("Separator:", sep)
        _ap = GPFPMiner(iFile=iFile, minSup=minSup, maxPer=maxPer, nFile=nFile, sep=sep)
        _ap.mine()
        _ap.save(oFile)
        ...
        _ap = GPFPMiner(iFile=iFile, minSup=minSup,  maxPer=maxPer, nFile=nFile)
        _ap.mine()
        _ap.save(oFile)
