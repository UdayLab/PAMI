...
class FCPGrowth(_ab._corelatedFuzzyFrequentPatterns):
    ...
    **Executing the code on terminal :**
    ...
    .. code-block:: console
      ...
      (.venv) $ python3 FCPGrowth112.py <inputFile> <outputFile> <minSup> <minAllConf> <sep>

      Example Usage:

      (.venv) $ python3 FCPGrowth112.py sampleTDB.txt output.txt 2 0.2
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 5:
        ...
        print("ratioExample:", minAllConf)
        print("Separator:", sep)

        _ap = FCPGrowth(iFile=iFile, minSup=minSup, minAllConf=minAllConf, sep=sep)
        _ap.mine()
        ...
        print("Input File:", iFile)
        print("Minimum Support List:", minSup)
        print("Minimum ALL CONF:", minAllConf)

        _ap = FCPGrowth(iFile=iFile, minSup=minSup,minAllConf = minAllConf)
        _ap.mine()
