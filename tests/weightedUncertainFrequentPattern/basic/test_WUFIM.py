...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 7:
        ...
        wFile = _ab._sys.argv[2]
        expSup = _ab._sys.argv[3]
        expWSup = _ab._sys.argv[4]
        ...
        print("exp List:", expSup)
        print("exp weight List:", expWSup)
        print("Output File:", oFile)
        print("Separator:", sep)
        _ap = WUFIM(iFile=iFile, wFile= wFile, expSup=expSup, expWSup=expWSup, sep=sep)
        _ap.mine()
        _ap.save(oFile)
        ...
        _ap = WUFIM(iFile=iFile, wFile= wFile, expSup=expSup, expWSup=expWSup)
        _ap.mine()
        _ap.save(oFile)
