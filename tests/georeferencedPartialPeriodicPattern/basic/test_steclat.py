...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 7:
        ...
        minPS = _ab._sys.argv[2]
        maxIAT = float(_ab._sys.argv[3])
        ...
        print("Minimum partial support:", minPS)
        print("maxIAT:", maxIAT)
        print("nFile:", nFile)
        print("Output File:", oFile)
        print("Separator:", sep)
        _ap = STEclat(iFile=iFile, minPS=minPS, maxIAT=maxIAT, nFile=nFile, sep=sep)
        _ap.mine()
        _ap.save(oFile)
        ...
        _ap = STEclat(iFile=iFile, minPS=minPS, maxIAT=maxIAT, nFile=nFile)
        _ap.mine()
        _ap.save(oFile)
