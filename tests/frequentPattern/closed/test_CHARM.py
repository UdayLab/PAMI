    ...
    def _creatingItemsets(self):
        ...
        if isinstance(self._iFile, _ab._pd.DataFrame):
            ...
            if 'Transactions' in i:
                ...
                print(
                    "The column name should be Transactions and each line should be separated by tab space or a separator specified by the user")
                return []
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 5:
        ...
        print("Separator:", sep)
        _ap = CHARM(iFile=iFile, minSup=minSup, sep=sep)
        _ap.mine()
        _ap.save(oFile)
        ...
        _ap = CHARM(iFile=iFile, minSup=minSup)
        _ap.mine()
        _ap.save(oFile)
