...
class FAE(_ab._frequentPatterns):
    ...
    **Terminal command**
    ...
    .. code-block:: console
      ...
      (.venv) $ python3 test_FAE.py <inputFile> <outputFile> <K>

      Example Usage:

      (.venv) $ python3 test_FAE.py sampleDB.txt patterns.txt 10.0
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 5:
        ...
        print("Separator:", sep)
        _ap = FAE(iFile=iFile, k=minSup, sep=sep)
        _ap.mine()
        _ap.save(oFile)
