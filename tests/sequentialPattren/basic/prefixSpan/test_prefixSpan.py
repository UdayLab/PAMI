...
from prefixSpan import test_pami
import warnings
...
class TestExample(unittest.TestCase):
    def test_num_patterns(self):
        for _ in range(3):
            num_distinct_items = 100
            num_transactions = 1000
            max_items_per_sequence = 3
            max_sequence_per_transaction = 5
            items = ["item-{}".format(i) for i in range(1, num_distinct_items + 1)]
            dataset = generate_sequentional_dataset(num_transactions, items, max_items_per_sequence,
                                                     max_sequence_per_transaction)
    ...
    def test_equality(self):
        for _ in range(3):
            ...
            max_sequence_per_transaction = 5
            items = ["item-{}".format(i) for i in range(1, num_distinct_items + 1)]
            dataset = generate_sequentional_dataset(num_transactions, items, max_items_per_sequence,max_sequence_per_transaction)
