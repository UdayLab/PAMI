...
class CoMine(_ab._correlatedPatterns):
    ...
    **Calling from a python program**
    ...
    def __init__(self, iFile: Union[str, _pd.DataFrame], minSup: Union[int, float, str], minAllConf: float,
                 sep: str = "\t") -> None:
        """
...
if __name__ == "__main__":
    ...
    if len(_ab._sys.argv) == 6:
        ...
        minSup = _ab._sys.argv[2]
        minAllConf = float(_ab._sys.argv[3])
        ...
        print("Minimum All Confidence:", minAllConf)
        print("Output File:", oFile)
        print("Separator:", sep)
        _ap = CoMine(iFile=iFile, minSup=minSup, minAllConf=minAllConf, sep=sep)
        _ap.mine()
        _ap.save(oFile)
        ...
        _ap = CoMine(iFile=iFile, minSup=minSup, minAllConf=minAllConf)
        _ap.mine()
        _ap.save(oFile)
        ...
        raise WrongNumberOfArguments(
            "Please provide four arguments: iFile, minSup and oFile \n""or Please provide five arguments: iFile, minSup, oFile and sep"
        )
